## Simulations
The animations below are of time-dependent solutions to the equations of non-adiabatic gas dynamics, obtained with [Athena++](https://github.com/PrincetonUniversity/athena-public-version/wiki) (v19).  These are axisymmetric (2.5D) calculations performed in spherical coordinates.  For further details on the numerics, see the appendix of the paper.  
